...
Where bsl.year = 2021 AND bsl.month = 28 AND bsl.day = 28 AND bsl.hour = 10 AND bsl.minute BETWEEN 15 AND 25;

-- check witness 2 atm--
SELECT * FROM atm_transactions
WHERE atm_location = 'Leggett Street'
AND year = 2021 AND month = 7 AND day = 28;
--add name of withdarw from atm--
SELECT a.*, p.name
...
-- narrow down from bruce/diana who is in flight--
SELECT p.name
FROM people p
